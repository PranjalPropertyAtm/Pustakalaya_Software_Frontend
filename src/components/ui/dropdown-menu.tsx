...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5", typography.dropdownLabel, inset && "pl-8", className)}
    {...props}
  />
));
...
const DropdownMenuShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span className={cn(typography.muted, "ml-auto tracking-widest opacity-60", className)} {...props} />
);
