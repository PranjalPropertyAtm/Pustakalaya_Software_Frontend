...
export const endpoints = {
  ...
  studentSeatRelease: (id: string) => `${API}/students/${id}/seat/release`,
  ...
  enquiry: (id: string) => `${API}/enquiries/${id}`,
  enquiryFollowUps: (id: string) => `${API}/enquiries/${id}/follow-ups`,
  enquiryReminders: (id: string) => `${API}/enquiries/${id}/reminders`,
  enquiryTimeline: (id: string) => `${API}/enquiries/${id}/timeline`,
  enquiryClose: (id: string) => `${API}/enquiries/${id}/close`,
  enquiryCancel: (id: string) => `${API}/enquiries/${id}/cancel`,
  enquiryConvert: (id: string) => `${API}/enquiries/${id}/convert`,
  enquiryDashboard: `${API}/enquiries/dashboard`,
  enquiryReports: `${API}/enquiries/reports`,
  enquiryExport: `${API}/enquiries/export`,
} as const;
